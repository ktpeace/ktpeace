...
- Learning Docker & Fly.io to host the backend of a simple [app](https://github.com/ktpeace/milkwall) whose page of text any visitor can edit for all. It uses React, Express, and a JSON database for its two values. The frontend is hosted on Netlify
